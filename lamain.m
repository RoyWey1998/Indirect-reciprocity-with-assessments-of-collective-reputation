% main code for reputation evolving process with 3-lambda version
tic
...
parfor nPs = 1:nPopstc
    ...
    popstc = Popstc60(nPs,:); % pick one population structure
    % run for cooperation rate (whole as well as separate) under this
    % population structure
    [CR,crspt1,crspt2,crspt3] = larepevo2cr(str,popstc,N,ngs,repItnum,kmin,kmax,Gamestc10,q,err,lambda_list);
    allCR(nPs,:) = CR;
